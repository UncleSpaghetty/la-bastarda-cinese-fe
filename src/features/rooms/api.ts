...
export type RoomState = {
  ...
  settings: { preset: string; max_players: number; turn_seconds: number; warning_seconds: number; max_consecutive_timeouts: number; spectators_enabled: boolean; max_spectators: number; invite_expiry_hours: number };
...
export type RoomPreset = {
  ...
  constraints: Partial<Record<keyof Omit<RoomSettingsInput, "preset" | "spectators_enabled">, NumericConstraint>>;
};
