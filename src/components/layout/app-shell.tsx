...
export function AppShell() {
  ...
  return <div className="min-h-dvh bg-app text-foreground">
    ...
    {!isGameTable && <header className="app-header">
      <Link to="/" className="brand-link" onClick={close} aria-label="La bastarda cinese — Homepage">
        <img className="brand-mark" src="/brand/logo-mark.svg" width="38" height="38" alt="" aria-hidden="true" />
        <span className="brand-wordmark" aria-hidden="true"><span className="brand-prefix">La</span> <strong>bastarda</strong> <span className="brand-suffix">cinese</span></span>
      </Link>
