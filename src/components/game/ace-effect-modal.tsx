...
export function AceEffectModal({ phase, targets = [], own, hand, tableCards, deadline, pending, busy, onCommand }: {
  ...
  useEffect(() => { setDismissed(false); setTargetId(undefined); }, [phase]);
